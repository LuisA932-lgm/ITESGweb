...
<body>
    ...
    <?php
    $nombre=["Carmen del Rosio Esparza Valencia","Fernanda Berenice Márquez Vélez"
    ,"José Alejandro Castro Téllez","Sandra Guadalupe Salas Torres","Elihu Jonathan Granados Montero"
    ,"Luz Elena Isadora Zendejas Chavez","Ernesto Ibarra Rodríguez","Sandra Selene Torres Durán","V A C A N T E"
    ,"Juan Alonso Rocha Valadez","Juan Manuel Juárez Pérez","Daniela Yadira Ortiz Pérez","Karina Hernández Blancarte"
    ,"David Hernández Tinoco","V A C A N T E"];
    $puesto=["Subdirector(a) de Planeación y Vinculación","Secretaria(o) de Subdirección","Jefe(a) de Departamento de Vinculación y Extensión"
    ,"Coordinador(a) de Promociones/ Difusión y Comunicación","Secretaria(o) de Jefe de Departamento","Bibliotecaria(o)/Encargado(a) de Biblioteca"
    ,"Jefe(a) de Departamento de Calidad/Actividades Extraescolares y de Innovación","Analista Técnico"
    ,"Jefe(a) de Departamento de Planeación, Programación y Presupuesto/ Evaluación","Jefe(a) de Departamento de Servicios Escolares","Analista Técnico"
    ,"Analista Técnico/Analista Técnico Especializado","Programadora","Secretario(a) de Jefe de Departamento","Capturista de Jefe de Departamento"];
    $correo=["carmen.ev@guanajuato.tecnm.mx","fernanda.mv@guanajuato.tecnm.mx","jefaturadevinculacion@guanajuato.tecnm.mx","difusion@guanajuato.tecnm.mx"
    ,"elihu.gm@guanajuato.tecnm.mx","biblioteca@guanajuato.tecnm.mx","ernesto.ir@guanajuato.tecnm.mx","sandra.td@guanajuato.tecnm.mx","@guanajuato.tecnm.mx"
    ,"juan.rv@guanajuato.tecnm.mx","juan.jp@guanajuato.tecnm.mx","daniela.op@guanajuato.tecnm.mx","karina.hb@guanajuato.tecnm.mx","david.ht@guanajuato.tecnm.mx","@guanajuato.tecnm.mx"];
    $telefono="473 73 47878";
    echo '<table class="table">
        <thead>
            <tr>
