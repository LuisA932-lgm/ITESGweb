...
<body>
    <article class="article fulltext ">
        <section class="article-body">
            ...
            <div>
                <img src="/sistemas/images/comite/COM_COD_ETI.jpg">
            </div>

            <div class="text-center">
                <a href="/sistemas/images/comite/cod_etica.pdf" target="_blank">
                    <img src="/sistemas/images/display/info_ccond.jpg" class="img-full-width">
                </a>
            </div>
            ...
            <div class="text-center">
                <img src="/sistemas/images/comite/BAN_WEB_COM_INT.jpg" class="img-full-width">
            </div>
            ...
            <a href="/sistemas/images/comite/' . $ligas[$i] . '">';
                    ...
                    echo '<div class="d-flex align-items-center my-3">
            <img src="/sistemas/images/comite/' . $img[1] . '"alt="Ícono de Código" class="me-3" style="width: 70px; height: 70px;">
            <a href="/sistemas/images/comite/' . $ligas[$i] . '">';
                }
            ...
            <div class="text-center">
                <a href="/sistemas/images/documentos/codigo_conducta23.pdf" target="_blank">
                    <img src="/sistemas/images/display/info_cetica.jpg" class="img-full-width">
                </a>
            </div>
            <?php
