...
.font-changer button:hover {
  ...
  <center>   
          ...
          <a href="http://localhost/ITESGWEB/sistemas/views/hola.php?option=com_content&amp;view=article&amp;id=68&amp;Itemid=572"><button type="button" style="color: #2EC3F8; font-size: 22px " class="  btn " onclick="changeColor(this)">2018</button>
