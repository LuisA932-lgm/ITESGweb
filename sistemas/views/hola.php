...
.font-changer button:hover {
 ...
 <center class="Ti">Información Financiera - Armonización Contable LGCG y LDF</center>
  <center>   
          ...
          <a href="http://localhost/ITESGWEB/sistemas/Informacion_Financiera/2023.php"><button type="button" style="color: #2EC3F8; font-size: 22px " class="  btn btn-default">2018</button>
