...
MX.secBuilder = function () {
	...
	'<header>'+
		'<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">'+
            ...
            '<img src="https://framework-gb.cdn.gob.mx/landing/img/logoheader.svg" width="128" height="48" alt="PÃƒÆ’Ã‚Â¡gina de inicio, Gobierno de MÃƒÆ’Ã‚Â©xico">'+
			      // '<img src="' + MX.imagesPath + 'gobmxlogo-3.svg" width="75" height="23" alt="PÃƒÆ’Ã‚Â¡gina de inicio, Gobierno de MÃƒÆ’Ã‚Â©xico">'+
			    '</a>'+
			  '</div>'+
  ...
  '<footer class="main-footer">'+
    '<div class="list-info">'+
      '<div class="container">'+
        '<div class="row">'+
          '<div class="col-sm-3">'+
            '<img data-v-9e928f9a="" src="https://framework-gb.cdn.gob.mx/landing/img/logoheader.svg" href="/" alt="logo gobierno de mÃƒÆ’Ã‚Â©xico" class="logo_footer" style="max-width: 90%;">'+ 
          '</div>'+
          '<div class="col-sm-3">'+
            '<h5>Enlaces</h5>'+
            '<ul>'+
